        ...
        <>
            {showModal && (
                <div className="fixed inset-0 bg-gray-800 bg-opacity-80 flex justify-center items-center min-h-screen z-50">
                    <div className="relative bg-gradient-to-r from-yellow-300 via-orange-300 to-red-300 border-yellow-500 transform p-8 rounded-lg shadow-xl w-11/12 max-w-xl">
                        {/* Close Icon */}
                        <button
                            onClick={handleCloseModal}
                            className="absolute top-3 right-3 text-gray-800 p-2 text-xl hover:bg-opacity-80 transition duration-200"
                        >
                        ...
                        <button
                            ...
                            className="btn btn-primary rounded-lg w-full text-md font-semibold shadow-md transform hover:scale-105 transition duration-300"
                        >
                            Upgrade Now
                        </button>
